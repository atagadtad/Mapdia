...
INSERT INTO maps
  (owner_id, description, category, url, liked)
VALUES(1 'Italian restaurants I''d like to eat at', "foody",4);
  (owner_id, description, category, url, liked)
VALUES(1, 'Italian restaurants I''d like to eat at', "foody", 8);
  (owner_id, description, category, url, liked)
VALUES(2, 'Italian restaurants I''d like to eat at', "foody", 10);
  (owner_id, description, category, url, liked)
VALUES(2, 'Italian restaurants I''d like to eat at', "foody", 12);
  (owner_id, description, category, url, liked)
VALUES(3, 'Italian restaurants I''d like to eat at', "foody", 2);
